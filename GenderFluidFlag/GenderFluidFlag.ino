...
// COLORS
CRGB gfPink = CRGB(252,116,159);
CRGB white = CRGB::White;
CRGB gfPurp = CRGB(185,24,209);
CRGB black = CRGB(20,20,20);
CRGB gfBlue = CRGB(26, 41, 237);

// ORDER OF COLORS
// !!!  CHANGE THE AMOUNT OF COLORS IN THE ARRAY IF YOU CHANGE THE FLAGSEGMENTTOTAL !!!

CRGB inputArray[flagSegmentTotal] = {gfPink, white, gfPurp, black, gfBlue};
